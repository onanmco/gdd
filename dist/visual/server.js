...
export async function prepareVisualCompanion(planDir) {
...
export async function prepareDiagramCompanion(planDir) {
...
export async function startVisualCompanion(visualDir, port) {
    return startStaticServer(visualDir, port ?? 4377, "GDD visual companion", true);
}
async function startStaticServer(rootDir, preferredPort, label, captureEvents) {
...
function diagramViewerHtml(flowchart, sequence) {
    return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
